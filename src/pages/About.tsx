    ...
    <div className="relative z-10 min-h-screen px-6 py-24 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
        ...
        >
          ...
          <p className="text-white/60 text-xl font-montserrat leading-relaxed">
            Karana was founded on a simple premise: that the most ambitious engineering projects require more than just expertise—they require a cosmic perspective.
          </p>
          <p className="text-white/60 text-lg font-montserrat leading-relaxed">
            We are a multidisciplinary collective of engineers, designers, and scientists dedicated to turning theoretical breakthroughs into tangible reality. From the depths of the ocean to the fringes of the stratosphere, Karana operates where technical complexity meets visionary ambition.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            ...
            <div className="relative z-10 text-center">
               <div className="w-20 h-20 bg-cosmic-gold rounded-full flex items-center justify-center text-cosmic-black mx-auto mb-6 font-black text-3xl">K</div>
               <h3 className="text-white font-bold text-2xl font-montserrat">Engineering the <br />Impossible</h3>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <div className="space-y-20">
        <div className="text-center">
          <h2 className="text-3xl md:text-5xl font-black font-montserrat text-white tracking-tight mb-4">
            OUR <span className="text-cosmic-gold">CORE VALUES</span>
          </h2>
          <p className="text-white/50 text-lg max-w-2xl mx-auto font-montserrat">
            The principles that guide every simulation, every line of code, and every prototype we build.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, idx) => (
            ...
            >
              <div className="w-12 h-12 bg-cosmic-gold/10 rounded-xl flex items-center justify-center text-cosmic-gold mb-6 group-hover:scale-110 transition-transform">
                <value.icon size={24} />
              </div>
              <h4 className="text-white font-bold text-lg mb-4 font-montserrat">{value.title}</h4>
      ...
      <section className="py-32 text-center">
        ...
        >
          ...
          <p className="text-white/70 text-lg font-montserrat italic">
            "We don't just aim for industry standards. We aim for the standard by which the industry will be measured for the next decade."
          </p>
        </motion.div>
      </section>
    </div>
